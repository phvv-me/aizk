...
from ..retrieval import Plan, QueryContext, recall
from ..retrieval.recall import build_recall_statement
...
# A million rows is opt-in because it dominates the default sweep.
...
type Row = dict[str, uuid.UUID | str | int | list[float] | list[uuid.UUID] | dict | None]
