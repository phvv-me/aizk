...
[Web boilerplate](/docs/dev/write/boilerplate/) drops the menus an HTML page carries, and
[OCR and languages](/docs/dev/write/ocr/) names the engine that reads a scan.
